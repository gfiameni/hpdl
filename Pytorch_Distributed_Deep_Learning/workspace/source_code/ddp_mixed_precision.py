...
def create_data_loader_cifar10():
    ...
    trainset = torchvision.datasets.CIFAR10(root='/workspace/source_code/data', train=True,
    ...
    testset = torchvision.datasets.CIFAR10(root='/workspace/source_code/data', train=False,
                                        download=True, transform=transform)
