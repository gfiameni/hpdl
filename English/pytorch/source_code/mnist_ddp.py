...
def demo_basic(rank, world_size, args, use_cuda):
    ...
    # ---------------- Data ------------#
    train_dataset = torchvision.datasets.MNIST(root='/workspace/pytorch/source_code/data',
                                               train=True,
    ...
    test_dataset = torchvision.datasets.MNIST(root='/workspace/pytorch/source_code/data',
                                               train=False,
                                               transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.1307,), (0.3081,))
